...
company = Company()
company.name = 'PALACIO DEL HOGAR.'
company.ruc = '09999999999'
company.email = 'info@palaciodelhogar.com'
company.phone = '039399399'
company.mobile = '755714551'
company.desc = 'Ventas Al Por Mayor Y Por Menor En Productos para el hogar.'
company.website = 'palacio.com'
company.address = 'Parque California 2 Bodefa F38-F39'
company.iva = 12.00
company.save()
...
module = Module()
module.moduletype_id = 2
module.name = 'Sucursal'
module.url = '/pos/scm/sucursal/'
module.is_active = True
module.is_vertical = True
module.is_visible = True
module.icon = 'fas fa-server'
module.description = 'Permite administrar las sucursales de la compañia'
module.save()
for p in Permission.objects.filter(content_type__model=Sucursal._meta.label.split('.')[1].lower()):
    module.permits.add(p)
print('insertado {}'.format(module.name))
...
module.moduletype_id = 2
module.name = 'Marcas'
module.url = '/pos/scm/brand/'
module.is_active = True
module.is_vertical = True
module.is_visible = True
module.icon = 'fas fa-code-branch'
module.description = 'Permite administrar las marcas de los modelos'
module.save()
for p in Permission.objects.filter(content_type__model=Brand._meta.label.split('.')[1].lower()):
    module.permits.add(p)
print('insertado {}'.format(module.name))
...
module.moduletype_id = 2
module.name = 'Modelos'
module.url = '/pos/scm/exemplar/'
module.is_active = True
module.is_vertical = True
module.is_visible = True
module.icon = 'fas fa-ring'
module.description = 'Permite administrar los modelos de los productos'
module.save()
for p in Permission.objects.filter(content_type__model=Exemplar._meta.label.split('.')[1].lower()):
    module.permits.add(p)
print('insertado {}'.format(module.name))
