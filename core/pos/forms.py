...
class SucursalForm(ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            'name': forms.TextInput(attrs={'placeholder': 'Ingrese un nombre'}),
            'location': forms.TextInput(attrs={'placeholder': 'Ingrese una ubicación'}),
            'serie': forms.TextInput(attrs={'placeholder': 'Ingrese una serie'}),
        }
...
class ProductForm(ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            'name': forms.TextInput(attrs={'placeholder': 'Ingrese un nombre'}),
            'reference': forms.TextInput(attrs={'placeholder': 'Ingrese una referencia'}),
            'code': forms.TextInput(attrs={'placeholder': 'Ingrese un código'}),
            'detail': forms.Textarea(attrs={'placeholder': 'Ingrese los detalles del productos', 'rows': 3, 'cols': 3}),
            ...
            'pvp': forms.TextInput(),
            'stock_minimum': forms.TextInput(),
            'stock_maximum': forms.TextInput(),
        }
        exclude = ['stock']
...
class StockMovementForm(ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'borigen': forms.Select(attrs={'class': 'form-control select2', 'style': 'width: 100%;'}),
            'bodestino': forms.Select(attrs={'class': 'form-control select2', 'style': 'width: 100%;'}),
            'provider': forms.Select(attrs={'class': 'custom-select select2'}),
            'payment_condition': forms.Select(attrs={'class': 'form-control select2', 'style': 'width: 100%;'}),
            'end_credit': forms.DateInput(format='%Y-%m-%d', attrs={
                'class': 'form-control datetimepicker-input',
