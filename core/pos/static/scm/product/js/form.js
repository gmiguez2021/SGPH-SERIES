            ...
            fields: {
                ...
                code: {
                    validators: {
                        ...
                        regexp: {
                            regexp: /^[A-Za-z0-9]+$/i,
                            message: 'El código solo debe estar conformado por letras y números'
                        },
                        stringLength: {
                            min: 2,
                        },
...
$(function () {
    ...
    $('select[name="exemplar"]').on('change', function () {
        fv.revalidateField('exemplar');
    });

    $('input[name="stock_maximum"]')
        .TouchSpin({
            min: 1,
            max: 1000000,
            step: 1,
        ...
        .on('change touchspin.on.min touchspin.on.max', function () {
            fv.revalidateField('stock_maximum');
        })
        .on('keypress', function (e) {
            return validate_form_text('numbers', e, null);
        });

    $('input[name="stock_minimum"]')
        .TouchSpin({
            min: 1,
            max: 1000000,
            step: 1,
        ...
        .on('change touchspin.on.min touchspin.on.max', function () {
            fv.revalidateField('stock_minimum');
        })
        .on('keypress', function (e) {
            return validate_form_text('numbers', e, null);
        });
