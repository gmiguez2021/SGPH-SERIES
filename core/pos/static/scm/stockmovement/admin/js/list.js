        ...
        columnDefs: [{
...

            {
                ...
                render: function(data, type, row) {
                    ...
                    buttons += '<a href="/pos/scm/stockmovement/print/request/' + row.id + '/" target="_blank" class="btn btn-primary btn-xs btn-flat"title= "Solicitud"><i class="fas fa-print"></i></a> ';
