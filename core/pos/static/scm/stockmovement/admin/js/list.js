        ...
        columnDefs: [{
...

            {
                ...
                render: function(data, type, row) {
                    ...
                    buttons += '<a href="/pos/scm/stockmovement/delete/' + row.id + '/" class="btn btn-danger btn-xs btn-flat"><i class="fas fa-trash"></i></a> ';
                    buttons += '<a href="/pos/scm/stockmovement/print/request/' + row.id + '/" target="_blank" class="btn btn-primary btn-xs btn-flat"title= "Solicitud de Transferencia"><i class="fas fa-print"></i></a> ';
